...
<body>
	...
	<div class="leri">
		...
		<div class="opt">
	        ...
	        <a class="atag" href="budget-planning.php"><input class="button" type="button" value="Budget Planning"></a>
	        <a class="atag" href="expenditure.php"><input class="button" type="button" value="My Expenses"></a>
	        <a class="atag" href="my-wallet.php"><input class="button" type="button" value="My Wallet"></a>
